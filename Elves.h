...
public:
//constructors
Elves(string name="", int units=0, int attackpt=0, int healthpt=0, int regennum=0, int tothealth=0, bool alive=true, Faction* first_enemy=NULL, Faction* second_enemy=NULL);
Elves(const Elves &ptr);
~Elves();
